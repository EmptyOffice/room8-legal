...
Delete your account yourself from Settings → Danger Zone → Delete account. For anything else, write to support@room8.xyz, marking the subject "Privacy request" so it is routed correctly. We respond within 45 DAYS — CCPA'S LIMIT.

5\. Children

Room8 is not for children under 13 and we do not knowingly collect their information. If we learn we have, we delete it. If you believe a child has registered, write to support@room8.xyz.
...
We will notify you in the app before a material change takes effect. Room8 is run by two individuals, not a company, and has no business premises; the controller of your data is FELIX PANTOJA and EDELSON GARCIA, reachable at support@room8.xyz.  
